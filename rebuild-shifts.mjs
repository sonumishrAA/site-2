...
async function rebuild() {
  ...
  console.log(`Found ${students.length} students. Rebuilding all shifts...`)
  
  // 1. Delete ALL current shifts to start fresh
  await supabase.from('student_seat_shifts').delete().neq('shift_code', 'INVALID')
